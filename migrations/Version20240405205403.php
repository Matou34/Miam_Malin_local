 ...
 */
final class Version20240405205403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recettes CHANGE re_commentaires re_commentaires LONGTEXT DEFAULT NULL');
    }
