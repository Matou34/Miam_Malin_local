...
class UnitesController extends AbstractController
{
    ...
    public function Display_List_Unités(UnitesRepository $repo): Response
    {
        $unites = $repo->findAllSortedByName();
        $isInitesUsed = [];
    ...
    public function Delete(Unites $unite,Request $request, EntityManagerInterface $manager): Response
    {
